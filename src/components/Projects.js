          ...
          <div class="col-6">
            <div class="p-3 border bg-light">
              ...
              <p>
                ...
                math operations. It performs the 4 basic operations in addition to handling percents and negative numbers. This app was created with functional components, state and hooks.
