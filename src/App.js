  ...
  return (
    <Router>
      <div className="App w-full lg:flex h-screen">
        ...
        <div className="relative z-10 px-4 mt-36 md:mt-16 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-6 lg:overflow-hidden">
          <Home />
        </div>
